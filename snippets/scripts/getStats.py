...
exchanges = [
    ...
    {'exchange': 'ETR', 'suffix': 'de'}, # xetra
    {'exchange': 'LIS', 'suffix': 'ls'}, # lisabon
    {'exchange': 'TSE', 'suffix': 'to'}, # Toronto Stock Exchange
    {'exchange': 'TSX', 'suffix': 'v'}, # TSX Venture Exchange
    # {'exchange': 'MEX', 'suffix': 'mx'}, # mexico
    # {'exchange': 'KRX', 'suffix': ['kq', 'ks']},
    # {'exchange': 'BOM', 'suffix': 'bo'}, # Bombay Stock Exchange
    # {'exchange': 'TAE', 'suffix': 'ta'} # Tel Aviv Stock Exchange
]
