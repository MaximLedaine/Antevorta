...
SPIDER_MODULES = ['mycrawler.spiders', 'mycrawler.spiders.yahoo']
...
DOWNLOADER_MIDDLEWARES = {
  ...
  'mycrawler.middlewares.RandomProxy': 100,
  'scrapy.downloadermiddlewares.httpproxy.HttpProxyMiddleware': 110,
  'mycrawler.middlewares.RotateUserAgentMiddleware': 80
}
...
# http://host3:port
# ...
PROXY_LIST = './proxies/proxies.txt'
# Proxy mode
